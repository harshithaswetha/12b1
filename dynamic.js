...
function education(edu){
  ...
  var tr1="<tr><td>degree</td><td>institution</td><td>yop</td><td>cgpa</td></tr>";
  var tr2="";
  for(i=0;i<edu.length;i++){
    tr2=tr2+"<tr><td>"+edu[i].degree+"</td><td>"+edu[i].institution+"</td><td>"+ edu[i].yop +"</td><td>"+edu[i].cgpa+"</td></tr>";
  }
